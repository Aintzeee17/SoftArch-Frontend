...
<body class="register-body" onload="toggleRegisterRole()">
...
<div class="box">
    ...
    <form action="${pageContext.request.contextPath}/RegisterServlet" method="post" autocomplete="off">
        ...
        <select name="role" id="regRole" onchange="toggleRegisterRole()" required>
        ...
        <div id="regMatricField" style="display:none;">
            <input type="text" name="matricNo" id="regMatricNo" placeholder="Matric Number">
        </div>
    ...
    <div class="link">
        Already have account? <a href="${pageContext.request.contextPath}/Login.jsp">Login</a>
    </div>
