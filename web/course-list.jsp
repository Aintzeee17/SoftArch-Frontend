...
<%
    ...
    // FIX 1: Check login & role (Admin/Lecturer sahaja)
    ...
    <div class="card">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="<%=request.getContextPath()%>/edit-course.jsp?id=<%=c.getCourseId()%>" class="btn-edit">Edit</a>

                    <form action="<%=request.getContextPath()%>/CourseServlet" method="post" style="display:inline;">
                        <input type="hidden" name="action" value="delete">
                        <input type="hidden" name="courseId" value="<%=c.getCourseId()%>">
                        <button type="submit" class="btn-delete" onclick="return confirm('Delete this course?')">Delete</button>
                    </form>
                </td>
            </tr>
            <%
